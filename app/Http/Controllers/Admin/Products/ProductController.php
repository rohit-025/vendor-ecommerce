...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $sizes = explode(",",$this->settingsRepo->sizes()->sizes);
    ...
    public function store(CreateProductRequest $request)
    {
        ...
        $data['sku'] = $this->productRepo->generateSku($request->input('name'));
        ...
        $stock = $this->stockRepo->createStock($request->size,$product->id);
    ...
    public function update(UpdateProductRequest $request, int $id)
    {
        ...
        $updateStock = $this->stockRepo->updateStock($request->size,$id);
