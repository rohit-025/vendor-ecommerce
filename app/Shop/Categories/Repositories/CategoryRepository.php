...
class CategoryRepository extends BaseRepository implements CategoryRepositoryInterface
{
    ...
    {
        return $this->model->orderBy('id', 'desc')->with('products')->get();
    }

    public function productByCategory($id)
    {
        $ids = $this->model->where('id',$id)->select('product_id')->get();
    ...
    {
        return $this->model->where('featured','=',1)->latest()->limit(7)->get();
    }
}
