        ...
        <div class="box">
            <form action="{{ route('admin.categories.update', $category->id) }}" method="post" class="form" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <img src="{{ asset($category->cover) }}" alt="" class="img-responsive" style="height:100px;width:100px"> <br/>
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" name="featured" value="1" @if($category->featured == 1) checked="checked" @endif>
                    </div>
                    <div class="form-group">
