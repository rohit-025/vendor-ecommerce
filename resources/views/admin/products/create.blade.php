                ...
                <div class="box-body">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="long_description" id="long_description" rows="5" placeholder="Long Description">{{ old('long_description') }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="quantity">Stock <span class="text-danger">*</span></label>
                            @foreach($sizes as $size)
                            <div class="input-group">
                            <span class="input-group-addon">{{ $size }}</span>
                            <input type="text" name="{{'size['.$size.']'}}" value="{{old('size['.$size.']')}}" id="quantity" placeholder="Quantity" class="form-control" value="{{ old('quantity') }}">
                            </div><br>
                            @endforeach
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                            <label for="quantity">Product Specifications(To be shown in tabular form on product description page.) <span class="text-danger">*</span></label>
