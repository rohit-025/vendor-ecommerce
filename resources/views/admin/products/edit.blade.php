                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control ckeditor" name="long_description" id="long_description" rows="5" placeholder="Long Description">{{ $product->long_description }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-3">
                                                <div class="row">
                                                    <img src="{{ asset($product->cover) }}" alt="" class="img-responsive img-thumbnail">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="quantity" id="quantity" placeholder="Quantity" class="form-control" value="{!! $product->quantity  !!}" readonly>
                                            @else
                                        ...
                                        <div class="form-group">
                                            <label for="quantity">Stock (By Size) <span class="text-danger">*</span></label>
                                            @foreach($product->stock as $stock)
                                            <div class="input-group">
                                                <span class="input-group-addon">{{ $stock->size }}</span>
                                                <input type="text" name="{{'size['.$stock->size.']'}}" value="{{$stock->stock}}" id="quantity" placeholder="Quantity" class="form-control" value="{{ old('quantity') }}">
                                            </div><br>
                                            @endforeach
                                        </div>
                                        <div class="form-group">
