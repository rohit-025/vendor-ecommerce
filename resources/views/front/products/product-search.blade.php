                    ...
                    <div class="pd-detail">
                        ...
                        <div>
                            <div class="pd-detail__inline">
                                ...
                                <span class="pd-detail__discount">{{ !!$product->sale_price ? ((($product->price - $product->sale_price)/$product->price)*100)." ".'% Off' : '' }} </span>
                                <del class="pd-detail__del">{{(!!$product->sale_price) ? env('CURRENCY_SYMBOL')." ".$product->price : ''}}</del>
                            </div>
                        </div>
                        ...
                        <div class="pd-detail__form">
                            <div class="u-s-m-b-15">
                                <a href="{{url('notify/'.$product->id)}}" class="btn btn--e-brand-b-2" style="padding: 0.5rem 1rem; border-radius: 0.375rem;">Notify Me</a>
                            </div>
                        </div>
                        @endif
                        <div class="u-s-m-b-15">
                                    ...
                                    <div class="u-s-m-b-30">
                                        <form class="pd-tab__rev-f2">
                                            ...
                                            <div class="rev-f2__group">
                                                <div class="u-s-m-b-15"><label class="gl-label" for="reviewer-text">YOUR REVIEW *</label><textarea class="text-area text-area--primary-style" id="reviewer-text"></textarea></div>
                                                <div>
                                                    <p class="u-s-m-b-30">
                                            ...
                                            <div class="product-o product-o--hover-on">
                                                <div class="product-o__wrap">
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                                        <img class="aspect__img" src="{{isset($product->cover) ? asset($product->cover) : asset('front/images/product/electronic/product13.jpg')}}" alt="" />
                                                    </a>

                                                    <div class="product-o__action-wrap">
                                                        <ul class="product-o__action-list">
                                                            <li>
                                                                <a data-modal="modal" data-modal-id="quick-look" data-tooltip="tooltip" wire:click="quick({{$product}})" data-placement="top" title="Quick View">
                                                ...
                                                <span class="product-o__name"> <a href="{{'product/'.$product->slug}}">{{$product->name}}</a></span>
                                 

                                                <span class="product-o__price">
                                                    {{config('cart.currency_symbol'). $product->price}}

                                                    <span class="product-o__discount">{{(!!$product->sale_price) ? config('cart.currency_symbol'). $product->sale_price : ""}}</span>
                                                </span>
                                            </div>
                                        </div>
                                        @endforeach
