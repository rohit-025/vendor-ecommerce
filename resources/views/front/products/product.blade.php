                    ...
                    <div class="pd u-s-m-b-30">
                        <div class="slider-fouc pd-wrap">
                            <div id="pd-o-initiate">
                                <div class="pd-o-img-wrap" data-src="{{asset($product->cover)}}">
                                    <img class="u-img-fluid" src="{{asset($product->cover)}}" data-zoom-image="{{asset($product->cover)}}" alt="">

                                </div>

                                @foreach($product->images as $image)
                                <div class="pd-o-img-wrap" data-src="{{asset($image->src)}}">
                                    <img class="u-img-fluid" src="{{asset($image->src)}}" data-zoom-image="{{asset($image->src)}}" alt="">
                                </div>
                                @endforeach
                                <!-- <div class="pd-o-img-wrap" data-src="front/images/product/product-d-3.jpg">

                                <img class="u-img-fluid" src="{{asset('front/images/product/product-d-3.jpg')}}" data-zoom-image="{{asset('front/images/product/product-d-3.jpg')}}" alt=""></div>
                            <div class="pd-o-img-wrap" data-src="{{asset('front/images/product/product-d-4.jpg')}}">

                                <img class="u-img-fluid" src="{{asset('front/images/product/product-d-4.jpg')}}" data-zoom-image="{{asset('front/images/product/product-d-4.jpg')}}" alt=""></div>
                            <div class="pd-o-img-wrap" data-src="{{asset('front/images/product/product-d-5.jpg')}}">

                                <img class="u-img-fluid" src="{{asset('front/images/product/product-d-5.jpg')}}" data-zoom-image="{{asset('front/images/product/product-d-5.jpg')}}" alt=""></div> -->
                        ...
                        <div class="u-s-m-t-15">
                            <div class="slider-fouc">
                                <div id="pd-o-thumbnail">
                                    ...
                                    @foreach($product->images as $image)
                                    <div>
                                        <img class="u-img-fluid" src="{{asset($image->src)}}" alt="">
                                    </div>
                                    @endforeach
                                    <!-- <div>

                                    <img class="u-img-fluid" src="{{asset('front/images/product/product-d-2.jpg')}}" alt=""></div>
                                <div>

                                    <img class="u-img-fluid" src="{{asset('front/images/product/product-d-3.jpg')}}" alt=""></div>
                                <div>

                                    <img class="u-img-fluid" src="{{asset('front/images/product/product-d-4.jpg')}}" alt=""></div>
                                <div>

                                    <img class="u-img-fluid" src="{{asset('front/images/product/product-d-5.jpg')}}" alt=""></div> -->
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pd-detail">
                        ...
                        <div>
                            <div class="pd-detail__inline">
                                ...
                                <span class="pd-detail__price">{{env('CURRENCY_SYMBOL')." ".((!!$product->sale_price) ? $product->sale_price : $product->price)}}</span>

                                <span class="pd-detail__discount">{{ !!$product->sale_price ? ((($product->price - $product->sale_price)/$product->price)*100)." ".'% Off' : '' }} </span><del class="pd-detail__del">{{(!!$product->sale_price) ? env('CURRENCY_SYMBOL')." ".$product->price : ''}}</del>
                            </div>
                        </div>
                        ...
                        <div class="u-s-m-b-15">
                            <div class="pd-detail__inline">
                                ...
                                @else
                                <span class="pd-detail__left">Only {{$product->quantity}} left</span>
                                @endif
                            </div>
                        </div>
                        <!-- <div>
                            <form class="m-order u-s-m-b-30">
                                <div class="m-order__select-wrapper">
                                    ...
                                    <label class="u-s-m-r-8" for="my-order-sort">Size:</label><select class="select-box select-box--primary-style" id="my-order-sort">
                            ...
                            <form class="pd-detail__form">
                                <div class="pd-detail-inline-2">
                                    ...
                                    @if($product->quantity > 0)
                                        <!-- <button class="btn btn--e-brand-b-2 cart" type="" data-item="{{$product->id}}">Add to Cart</button> -->
                                        <a href="#" class="btn btn--e-brand-b-2 cart" data-item="{{$product->id}}">Add to Cart</a>
                                        @else
                                        <p>Out Of Stock</p>
                                    @endif
                                    </div>
                        ...
                        <div class="pd-detail__form">
                            <div class="u-s-m-b-15">
                                ...
                                <a href="{{url('notify/'.$product->id)}}" class="btn btn--e-brand-b-2" style="padding: .5rem 1rem;border-radius: 0.375rem;">Notify Me</a>
                            </div>
                        </div>
                        @endif
                        <div class="u-s-m-b-15">
                            ...
                            <div class="product-o product-o--hover-on">
                                <div class="product-o__wrap">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                        ...
                                        <img class="aspect__img" src="front/images/product/electronic/product1.jpg" alt=""></a>
                            ...
                            <div class="product-o product-o--hover-on">
                                <div class="product-o__wrap">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                        ...
                                        <img class="aspect__img" src="front/images/product/electronic/product2.jpg" alt=""></a>
                                    <div class="product-o__action-wrap">
                                        <ul class="product-o__action-list">
                                            <li>
                            ...
                            <div class="product-o product-o--hover-on">
                                <div class="product-o__wrap">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                        ...
                                        <img class="aspect__img" src="front/images/product/electronic/product3.jpg" alt=""></a>
                                    <div class="product-o__action-wrap">
                                        <ul class="product-o__action-list">
                                            <li>
                            ...
                            <div class="product-o product-o--hover-on">
                                <div class="product-o__wrap">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                        ...
                                        <img class="aspect__img" src="front/images/product/electronic/product23.jpg" alt=""></a>
                                    <div class="product-o__action-wrap">
                                        <ul class="product-o__action-list">
                                            <li>
                            ...
                            <div class="product-o product-o--hover-on">
                                <div class="product-o__wrap">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                        ...
                                        <img class="aspect__img" src="front/images/product/electronic/product26.jpg" alt=""></a>
                                    <div class="product-o__action-wrap">
                                        <ul class="product-o__action-list">
                                            <li>
                            ...
                            <div class="product-o product-o--hover-on">
                                <div class="product-o__wrap">
                                    ...
                                    <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
                                        ...
                                        <img class="aspect__img" src="front/images/product/electronic/product30.jpg" alt=""></a>
                                    <div class="product-o__action-wrap">
                                        <ul class="product-o__action-list">
                                            <li>
