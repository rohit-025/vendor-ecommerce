        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ route('admin.banners.index') }}"><i class="fa fa-picture-o"></i> List banners</a></li>
                    <li><a href="{{ route('admin.banners.create') }}"><i class="fa fa-plus"></i> Create Banner</a></li>

                </ul>
            </li>
            <li class="header">DISCOUNT</li>
            <li class="treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ route('admin.coupons.index') }}"><i class="fa fa-gift"></i> List Coupons</a></li>
            ...
            <li class="treeview @if(request()->segment(2) == 'products' || request()->segment(2) == 'attributes' || request()->segment(2) == 'brands') active @endif">
                ...
                <ul class="treeview-menu">
                    @if($user->hasPermission('view-product'))<li><a href="{{ route('admin.offers.list') }}"><i class="fa fa-circle-o"></i>List Offers</a></li>@endif
                    @if($user->hasPermission('create-product'))<li><a href="{{ route('admin.offers.create') }}"><i class="fa fa-plus"></i> Create Offer</a></li>@endif
            ...
            <li class="">
                <a href="{{route('admin.settings')}}">
                    <i class="fa fa-anchor"></i> <span>Settings</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
            ...
            <li class="">
                <a href="{{route('admin.blogs.index')}}">
                    <i class="fa fa-anchor"></i> <span>Blogs</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
