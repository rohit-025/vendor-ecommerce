                                    ...
                                    <div class="c-f__form">
                                        <div class="u-s-m-b-16">
                                            <div class="u-s-m-b-15">
                                                ...
                                                <input class="input-text input-text--primary-style" type="text" id="coupon" name="coupon" wire:model.defer="coupon" placeholder="Coupon Code">
                                            </div>
                                            <div class="u-s-m-b-15">

                                                <button class="btn btn--e-transparent-brand-b-2" wire:click="submit">APPLY</button>
                                            </div>
                                        </div>
</div>
                                </div>
            ...
            <div class="checkout-f">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form class="checkout-f__delivery" method="post" action="{{route('customer.address.store',['customer' => Auth::id()])}}">
                            @csrf
                            <div class="u-s-m-b-30">
                                ...
                                <div class="gl-inline">
                                    <div class="u-s-m-b-15">
                                        ...
                                        <label class="gl-label" for="billing-fname">NAME *</label>

                                        <input class="input-text input-text--primary-style" type="text" id="billing-fname" data-bill="" value="{{Auth::user()->name}}" required>
                                    </div>
                                    <!-- <div class="u-s-m-b-15">
                                ...
                                <div class="u-s-m-b-15">
                                    ...
                                    <input class="input-text input-text--primary-style" type="text" id="billing-email" data-bill="" name="email" value="{{ Auth::user()->email }}" required>
                                </div>
                                <!--====== End - E-MAIL ======-->
                                ...
                                <div class="u-s-m-b-15">
                                    ...
                                    <input class="input-text input-text--primary-style" type="text" id="billing-phone" data-bill="" name="phone" placeholder="Contact" value="{{isset($defaultAddress->phone) ? $defaultAddress->phone : ''}}" required>
                                </div>
                                <!--====== End - PHONE ======-->
                                ...
                                <div class="u-s-m-b-15">
                                    ...
                                    <input class="input-text input-text--primary-style" type="text" id="billing-street" placeholder="House name and street name" data-bill="" name="address_1" value="{{isset($defaultAddress->address_1) ? $defaultAddress->address_1 : ''}}">
                                </div>
                                <div class="u-s-m-b-15">

                                    <label for="billing-street-optional"></label>

                                    <input class="input-text input-text--primary-style" type="text" id="billing-street-optional" placeholder="Apartment, suite unit etc. (optional)" data-bill="" name="address_2" value="{{isset($defaultAddress->address_2) ? $defaultAddress->address_2 : ''}}">
                                </div>
                                <!--====== End - Street Address ======-->
                                ...
                                <div class="u-s-m-b-15">
                                    ...
                                    <input class="input-text input-text--primary-style" type="text" id="billing-town-city" data-bill="" placeholder="City" name="city" value="{{isset($defaultAddress->city) ? $defaultAddress->city : ''}}" required>
                                </div>
                                <!--====== End - Town / City ======-->
                                ...
                                <div class="u-s-m-b-15">
                                    ...
                                    <input class="input-text input-text--primary-style" type="text" id="billing-zip" placeholder="Zip/Postal Code" data-bill="" name="zip" value="{{isset($defaultAddress->zip) ? $defaultAddress->zip : ''}}" required>
                                </div>
                                <!--====== End - ZIP/POSTAL ======-->
                                ...
                                <!-- <div class="u-s-m-b-10">
                                    ...
                                    <label class="gl-label" for="order-note">ORDER NOTE</label><textarea class="text-area text-area--primary-style" id="order-note"></textarea>
                                </div> -->
                                <div>
                        ...
                        <div class="o-summary">
                                    ...
                                    <div class="o-card">
                                        <div class="o-card__flex">
                                            <div class="o-card__img-wrap">
                                                ...
                                                <img class="u-img-fluid" src="{{isset($product['image']) ? asset($product['image']) : 'images/product/electronic/product3.jpg'}}" alt="">
                                            </div>
                                            <div class="o-card__info-wrap">
                                                ...
                                                <span class="o-card__quantity">{{$product['quantity'].",".$product['size']}}</span>
                                ...
                                <div class="o-summary__box">
                                    ...
                                    <div class="ship-b">
                                        ...
                                        <div class="ship-b__box u-s-m-b-10">
                                            <p class="ship-b__p">@if(isset($defaultAddress)){{$defaultAddress->address_1.','.$defaultAddress->address_2.','.$defaultAddress->city.','.$defaultAddress->zip}}<br>{{$defaultAddress->phone}}@endif</p>
                            ...
                            <div class="o-summary__section u-s-m-b-30">
                                <div class="o-summary__box">
                                    ...
                                    <form class="checkout-f__payment" method="post" action="{{route('checkout.store')}}">
                                        @csrf
                                        <div class="u-s-m-b-10">
                                        ...
                                        <div class="u-s-m-b-10">
                                            ...
                                            <div class="radio-box">
                                                ...
                                                <input type="radio" id="pay-pal" name="payment" value="stripe" disabled>
                                                <div class="radio-box__state radio-box__state--primary">

                                                    <label class="radio-box__label" for="pay-pal">Stripe</label>
                                                </div>
                                            </div>
                                            <!--====== End - Radio Box ======-->
